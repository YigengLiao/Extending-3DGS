...
from scene.cameras import Camera, split_camera_into_tiles
import numpy as np
...
def loadCam(args, id, cam_info, resolution_scale, is_nerf_synthetic, is_test_dataset):
    ...
    tile_cams = split_camera_into_tiles(cam, tile_side=args.tile_side, enable=args.use_tiled_cams, is_test_dataset=is_test_dataset)
